...
class AddGuardian extends Component
{
    ...
    {
        return view('livewire.guardians.add-guardian', [
    ...
    public function submitFormEdit(): void
    {
        ...
        try {
            ...
            $this->saveGuardianRecord($guardian);
    ...
    protected function saveGuardianRecord(?Guardian $guardian = null): void
    {
