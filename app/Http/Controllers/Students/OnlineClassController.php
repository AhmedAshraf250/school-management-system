...
{
    /**
     * Load classes with relations to avoid N+1 queries.
     */
     ...
     */
    public function indirectCreate(): View //  indirectCreate indirectCreate
    {
        $grades = Grade::query()->get();
     ...
     */
    public function store(StoreOnlineClassRequest $request): RedirectResponse
    {
        try {
     ...
     */
    public function storeIndirect(StoreIndirectOnlineClassRequest $request): RedirectResponse
    {
        try {
            $validated = $request->validated();
     ...
     */
    public function show(onlineClass $onlineClass): void
    {
        abort(404);
    }
     ...
     */
    public function edit(onlineClass $onlineClass): void
    {
        abort(404);
    }
     ...
     */
    public function update(StoreOnlineClassRequest $request, onlineClass $onlineClass): void
    {
        abort(404);
    }
