...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.students.admin.index', compact('students'));
    }

    public function create()
    {
        return view('pages.students.admin.add-student', $this->studentFormData());
    }
    ...
    public function edit(Student $student)
    {
        ...
        return view('pages.students.admin.edit', array_merge($formData, ['student' => $student]));
    }
    ...
    public function show(Student $student)
    {
        ...
        return view('pages.students.admin.show', ['student' => $student]);
    }
    ...
    public function getClassrooms(int $id)
    {
    ...
    public function deleteAttachment(Student $student, int $attachmentId)
    {
