...
class GraduationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('pages.students.graduation.management', array_merge($formData, compact('graduations')));
    }
    ...
    public function destroy(RollbackGraduationRequest $request, string $graduate): RedirectResponse
    {
    ...
    public function graduateBatch(StoreBulkGraduationRequest $request): RedirectResponse
    {
        try {
