                                ...
                                <form action="{{ route('teachers.store') }}" method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <input id="name_ar" type="text" name="name_ar" value="{{ old('name_ar') }}"
                                                class="form-control">
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col">
                                            <label
                                                for="specialization_id">{{ trans('Teacher_trans.specialization') }}</label>
                                            <select id="specialization_id" class="custom-select my-1 mr-sm-2"
                                                ...
                                                @foreach ($specializations as $specialization)
                                                    <option value="{{ $specialization->id }}" @selected((int) old('specialization_id') === $specialization->id)>
                                                        {{ $specialization->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col">
                                            ...
                                            <select id="gender_id" class="custom-select my-1 mr-sm-2" name="gender_id">
                                                ...
                                                @foreach ($genders as $gender)
                                                    <option value="{{ $gender->id }}" @selected((int) old('gender_id') === $gender->id)>
                                                        {{ $gender->name }}
                                                    </option>
                                                @endforeach
                                            </select>
