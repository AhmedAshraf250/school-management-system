                    ...
                    <form action="{{ route('questions.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <textarea name="answers" id="answers" class="form-control" rows="4" required>{{ old('answers') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="quiz_id" id="quiz_id" required>
                                        <option value="" selected disabled>{{ trans('Questions_trans.choose_quiz') }}</option>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="score" id="score" required>
                                        <option value="" selected disabled>{{ trans('Questions_trans.choose_score') }}</option>
                                        <option value="5" @selected(old('score') == 5)>5</option>
                                        <option value="10" @selected(old('score') == 10)>10</option>
                                        <option value="15" @selected(old('score') == 15)>15</option>
                                        <option value="20" @selected(old('score') == 20)>20</option>
                                    </select>
                                </div>
                            </div>
                        </div>
