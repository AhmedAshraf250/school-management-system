    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('online-classes.indirectStore') }}" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="meeting_id">{{ trans('OnlineClasses_trans.meeting_id_label') }} : <span class="text-danger">*</span></label>
                                <input class="form-control" id="meeting_id" name="meeting_id" type="text" value="{{ old('meeting_id') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="password">{{ trans('OnlineClasses_trans.password_label') }} : <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="start_url">{{ trans('OnlineClasses_trans.start_url_label') }} : <span class="text-danger">*</span></label>
                                <input class="form-control" id="start_url" name="start_url" type="url" value="{{ old('start_url') }}" required>
                            </div>
                        </div>

                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="join_url">{{ trans('OnlineClasses_trans.join_url_label') }} : <span class="text-danger">*</span></label>
                                <input class="form-control" id="join_url" name="join_url" type="url" value="{{ old('join_url') }}" required>
                            </div>
                        </div>
                    </div>
