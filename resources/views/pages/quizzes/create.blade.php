                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="subject_id" id="subject_id" required>
                                        <option value="" selected disabled>{{ trans('Quizzes_trans.choose_subject') }}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="teacher_id" id="teacher_id" required>
                                        <option value="" selected disabled>{{ trans('Quizzes_trans.choose_teacher') }}</option>
