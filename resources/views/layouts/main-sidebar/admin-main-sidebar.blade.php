@php
    ...
    $isLibrariesActive = request()->routeIs('libraries.*');
    ...
    <div class="scrollbar side-menu-bg" style="overflow-y: auto; overflow-x: hidden;">
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <li class="{{ $isGradesActive ? 'active' : '' }}">
                ...
                <ul id="Grades-menu" class="collapse {{ $isGradesActive ? 'show' : '' }}" data-parent="#sidebarnav">
            ...
            <li class="{{ $isStudentsActive ? 'active' : '' }}">
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#students-menu"><i
                        class="fas fa-user-graduate"></i>{{ trans('main_trans.students') }}<div class="pull-right"><i
                            class="ti-plus toggle-icon"></i></div>
                    <div class="clearfix"></div>
                </a>
                    ...
                    <li class="{{ $isStudentsGraduatesActive ? 'active' : '' }}">
                        ...
                        <ul id="Graduate-students" class="collapse {{ $isStudentsGraduatesActive ? 'show' : '' }}">
                            <li class="{{ request()->routeIs('graduates.index') ? 'active' : '' }}">
                                <a href="{{ route('graduates.index') }}">{{ trans('main_trans.add_Graduate') }}</a>
                            </li>
                            <li class="{{ request()->routeIs('graduates.index') ? 'active' : '' }}">
                                <a href="{{ route('graduates.index') }}">{{ trans('main_trans.list_Graduate') }}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="{{ $isExamsActive ? 'active' : '' }}">
                ...
                <ul id="Quizzes-icon" class="collapse {{ $isExamsActive ? 'show' : '' }}" data-parent="#sidebarnav">
            ...
            <!-- library-->
            <li class="{{ $isLibrariesActive ? 'active' : '' }}">
                ...
                <ul id="library-icon" class="collapse {{ $isLibrariesActive ? 'show' : '' }}"
                    data-parent="#sidebarnav">
                    <li class="{{ $isLibrariesActive ? 'active' : '' }}">
                        <a href="{{ route('libraries.index') }}">{{ trans('libraries_trans.page_title') }}</a>
                    </li>
                </ul>
            </li>
